...
var fileDescriptor_d265219a8a7b46e8 = []byte{
	...
	,
}
...
func (c *startNewGameClient) StartGame(ctx context.Context, in *StartGameRequest, opts ...grpc.CallOption) (*StartGameResponse, error) {
	out := new(StartGameResponse)
	err := c.cc.Invoke(ctx, "/judge.StartNewGame/StartGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedStartNewGameServer) StartGame(ctx context.Context, req *StartGameRequest) (*StartGameResponse, error) {
...
func _StartNewGame_StartGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartGameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StartNewGameServer).StartGame(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/judge.StartNewGame/StartGame",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StartNewGameServer).StartGame(ctx, req.(*StartGameRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _StartNewGame_StartGame_Handler,
		},
	},
